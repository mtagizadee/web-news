...
const NavBar = () => {
    const [animation, setAnimation] = useState('menu-close');
    ...
    return (
        <>
            ...
            <ul className={`
            fixed w-full bg-gray-100 h-[15vh] p-6 ${animation}
            sm:p-0 sm:static sm:flex items-center justify-evenly sm:bg-inherit sm:p-0 sm:w-24 sm:h-auto 2xl:text-[1.5rem] 2xl:w-32
            `}>
                {animation === 'menu-open' &&
                    <svg
                        onClick={onClose}
